...
export function PerformanceOptimizationHomeSection() {
  return (
        ...
        <div className="container relative z-10">
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
              Data You Need, Delivered Instantly
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              Automated web scraping solutions that extract <strong>clean, structured, and actionable data</strong> — exactly how and where you want it.
            </p>
